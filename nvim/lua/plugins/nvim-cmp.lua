return {
	{
		dir = pluginpaths .. "/nvim-cmp" ,
		name = "nvim-cmp",
		dependencies = {
			{ dir = pluginpaths .. "/luasnip"      },
			{ dir = pluginpaths .. "/cmp-nvim-lsp" },
			{ dir = pluginpaths .. "/cmp-buffer"   },
			{ dir = pluginpaths .. "/cmp-path"     },
			{ dir = pluginpaths .. "/cmp-calc"     },
			{ dir = pluginpaths .. "/cmp-emoji"    },
			{ dir = pluginpaths .. "/cmp-nvim-lua" },
			{ dir = pluginpaths .. "/cmp-spell"    },
			{ dir = pluginpaths .. "/cmp_luasnip"  },
		},
		config = function()
